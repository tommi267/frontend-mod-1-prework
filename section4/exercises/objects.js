...
*/
var email = {
  sender:  "tommi.t.nguyen@icloud.com",
  subject: "Turing School ",
  message: "Turing school is great",
  wordCount: 4,
  images: false
}
...
var emails = [
 {
  sender:  "khill@icloud.com",
  subject: "Party ",
  message: "Party at my house",
  wordCount: 4,
  images: false
 },
 {
   sender:  "turbotax@turbotax.intuit.com",
   subject: "Tax Refund ",
   message: "Tax Refund is ready!!!",
   wordCount: 4,
   images: false
 },
 {
   sender:  "statments@mail.synchronybank.com",
   subject: "Your Amazon Store Card Statement",
   message: "Your Amazon Store Card Statment is now available online",
   wordCount: 9,
   images: false
 }
]
